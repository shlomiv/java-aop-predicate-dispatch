...
public class Helper {	
	...
	static public class Builder {
			...
			public Builder any (List<F<Object, Boolean>>fs, String s) { l=l.cons(P.p(fs,s));return this;}
			public <T> Builder  any1 (List<F<T, Boolean>>fs, String s) { l=l.cons(P.p(fs.<F<Object, Boolean>>map(t->(F<Object, Boolean>)t),s));return this;}
